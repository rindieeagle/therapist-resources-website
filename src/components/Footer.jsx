...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="relative py-12 px-4 backdrop-blur-xl bg-white/10 border-t border-white/20 shadow-[0_-10px_30px_-15px_rgba(0,0,0,0.3)]">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center">
            <h3 className="text-white font-bold mb-4 font-playfair text-lg drop-shadow-md">Quick Links</h3>
          ...
          <div className="text-center md:text-right">
            <h3 className="text-white font-bold mb-4 font-playfair text-lg drop-shadow-md">Connect</h3>
            <div className="flex gap-4 justify-center md:justify-end mb-4">
              ...
              <motion.a 
                ...
                whileHover={{ scale: 1.1, rotate: -5 }} 
                whileTap={{ scale: 0.9 }} 
                className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-purple-500/50 backdrop-blur-sm border border-white/10 shadow-lg transition-all duration-300"
              >
