  ...
  return <>
      ...
      <div className="min-h-screen pt-20 pb-20 px-4">
        ...
        <div className="relative rounded-3xl overflow-hidden mb-16 h-[40vh] min-h-[400px]">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-900/90 via-slate-900/80 to-purple-900/60 backdrop-blur-sm flex items-center justify-center">
            <div className="text-center p-6 max-w-3xl">
              ...
              duration: 0.6
            }} className="text-4xl md:text-6xl font-bold font-playfair mb-6 bg-gradient-to-r from-purple-300 via-pink-300 to-cyan-300 bg-clip-text text-transparent">
        ...
        <div className="container mx-auto max-w-7xl">
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            scale: 1.02,
            y: -5
          }} className="group relative flex flex-col h-full bg-white/10 backdrop-blur-md border border-white/20 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300">
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500/20 to-cyan-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    <course.icon className="w-6 h-6 text-purple-300" />
                  </div>

                  <h3 className="text-xl font-bold text-white mb-2 font-playfair">{course.title}</h3>
                  ...
                  <div className="mt-auto space-y-4">
                    ...
                    <Button 
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white border-0 shadow-lg shadow-purple-900/20"
